...
k-fol validation. Folds are formed with stratified sampling.

Examples are shuffled within batches

Training sets are balanced using oversampling, data is augmented. Test sets are left as they are, no balancing. 
...
Here different models are compared.
...
% lipnet-4
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.9282) (SPC, 0.9950) (PPV, 0.9992) (NPV, 0.7073)};\label{legend:lipnet4}
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.6229) (SPC, 0.9895) (PPV, 0.9978) (NPV, 0.3112)};\label{legend:lipnet6}
% lipnet-9
%\addplot coordinates{(TPR, 0.6229) (SPC, 0.9895) (PPV, 0.9978) (NPV, 0.3112)};\label{legend:lipnet9}
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.8607) (SPC, 0.9801) (PPV, 0.9967) (NPV, 0.5068)};\label{legend:svm}



\nextgroupplot[title={Multilamellar}]
% cnn
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.9860) (SPC, 0.9782) (PPV, 0.8700) (NPV, 0.9980)};
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.9732) (SPC, 0.7145) (PPV, 0.3563) (NPV, 0.9949)};
% lipnet-9
%\addplot coordinates{(TPR, 0.6229) (SPC, 0.9895) (PPV, 0.9978) (NPV, 0.3112)};
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.9436) (SPC, 0.9708) (PPV, 0.8170) (NPV, 0.9921)};

\nextgroupplot[title={Uncertain}]
% cnn
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.6088) (SPC, 0.9528) (PPV, 0.1497) (NPV, 0.9975)};
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.3493) (SPC, 0.9154) (PPV, 0.0287) (NPV, 0.9958)};
% lipnet-9
%\addplot coordinates{(TPR, 0.6229) (SPC, 0.9895) (PPV, 0.9978) (NPV, 0.3112)};
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.9762) (SPC, 0.8990) (PPV, 0.0548) (NPV, 0.9998)};
...
% cnn
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.4989) (SPC, 0.9876) (PPV, 0.2050) (NPV, 0.9967)};
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.5812) (SPC, 0.9657) (PPV, 0.1223) (NPV, 0.9972)};
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.8879) (SPC, 0.9541) (PPV, 0.1128) (NPV, 0.9992)};

\nextgroupplot[title={Full}]
% cnn
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.8978) (SPC, 0.8440) (PPV, 0.9952) (NPV, 0.2021)};
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.7488) (SPC, 0.9462) (PPV, 0.9980) (NPV, 0.1048)};
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.8650) (SPC, 0.9239) (PPV, 0.9976) (NPV, 0.1577)};

\nextgroupplot[title={Uncertain}]
% cnn
\addplot[color=lblue, fill=lblue] coordinates{(TPR, 0.6290) (SPC, 0.9043) (PPV, 0.1325) (NPV, 0.9917)};
% lipnet-6
\addplot[color=lgreen, fill=lgreen] coordinates{(TPR, 0.7170) (SPC, 0.7781) (PPV, 0.0715) (NPV, 0.9926)};
% svm
\addplot[color=lred, fill=lred] coordinates{(TPR, 0.7257) (SPC, 0.9082) (PPV, 0.1405) (NPV, 0.9938)};
...
\matrix[
  ...
  {
    \ref{legend:lipnet4}& Lipnet--4 &[5pt]
    \ref{legend:lipnet6}& Lipnet--6 &[5pt]
    %\ref{legend:lipnet9}& Lipnet--9 &[5pt]
    \ref{legend:svm}& SVM \\};
\end{tikzpicture} 
\caption{\label{fig:svm_vs_cnn} Comparison of SVM and CNN (best viewed in color).}
\end{figure}
