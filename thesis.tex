...
% lipnet-1
\addplot coordinates{(TPR, 0.6719) (TNR, 0.9551) (PPV, 0.1062) (NPV, 0.9977)};
% svm
\addplot coordinates{(TPR, 0.8879) (TNR, 0.9541) (PPV, 0.1128) (NPV, 0.9992) ($F_1$, 0.9198)};

\nextgroupplot[title={Full}]
% lipnet-1
\addplot coordinates{(TPR, 0.7304) (TNR, 0.9403) (PPV, 0.9979) (NPV, 0.1038)};
% svm
\addplot coordinates{(TPR, 0.8650) (TNR, 0.9239) (PPV, 0.9976) (NPV, 0.1577) ($F_1$, 0.8935)};

\nextgroupplot[title={Uncertain}]
% lipnet-1
\addplot coordinates{(TPR, 0.6934) (TNR, 0.7708) (PPV, 0.0735) (NPV, 0.9921)};
% svm
